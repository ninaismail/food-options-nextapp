...
function BrandsCounter() {
  ...
  return (
    ...
    xs:flex xs:flex-wrap justify-evenly items-center">
        ...
        <div class="md:w-1/4 xs:w-1/2 w-full">
            <h2 class="text-5xl font-bold">+<CountUp end={100} duration={10}/></h2>
            <p>Partners</p>
        </div>
        <div class="md:w-1/4 xs:w-1/2 w-full">
            <h2 class="text-5xl font-bold">+<CountUp end={150} duration={10}/></h2>
            <p>Restaurent</p>
        </div>
        <div class="md:w-1/4 xs:w-1/2 w-full">
            <h2 class="text-5xl font-bold">+<CountUp end={19399} duration={10}/></h2>
            <p>Reviews</p>
        </div>                        
    </div>
  );

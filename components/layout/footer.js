...
function Footer() {
    return ( 
    <footer className="p-4 bg-my-beige-500 sm:p-6">
    <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 sm:gap-6 sm:w-8/12 sm:grid-cols-3">
            <div>
            ...
            <div>
                ...
                <ul className="text-gray-600">
                    <li>
                        <input className="mb-4 w-full" type="text" id='newsletterreg' name="wdform_2_element7" value="" title="Email" placeholder="Email" onchange="wd_check_email('2', '7', 'This is not a valid email address.')"/>
                   </li>
